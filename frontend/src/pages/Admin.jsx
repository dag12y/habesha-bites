...
const Admin = () => {
  ...
  const handleDeleteFood = async (foodId) => {
    ...
    try {
      ...
      alert(error.response?.data?.error || 'Failed to delete food item. Please try again.');
    }
  };
  ...
  const handleSaveFood = async (foodData) => {
    try {
      ...
      alert(error.response?.data?.error || 'Failed to save food item. Please try again.');
    }
  };
                ...
                <div key={food.id} className="food-item">
                  <div className="food-info">
                    ...
                    <div className="food-meta">
                      ...
                      <span className={food.isAvailable ? 'available' : 'unavailable'}>
